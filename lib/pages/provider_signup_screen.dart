  ...
  void _submitFormOnSignUp() async
  {
    ...
    if(isValid)
    {
      ...
      try {
        ...
        final uid = user!.uid;
        final ref = FirebaseStorage.instance.ref().child('providerImages').child('$uid.jpg');
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      textInputAction: TextInputAction.next,
                      onEditingComplete: () => FocusScope.of(context).requestFocus(_descFocusNode),
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value!.isEmpty) {
                          return 'Enter a valid description of your service';
                        } else {
                          return null;
                        }
                      },
