...
class UserBookingDetailsScreen extends StatefulWidget {
  ...
  const UserBookingDetailsScreen({Key? key, required this.bookingId})
      : super(key: key);

  @override
  _UserBookingDetailsScreenState createState() =>
      _UserBookingDetailsScreenState();
}

class _UserBookingDetailsScreenState
    extends State<UserBookingDetailsScreen> {
          ...
          body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, AsyncSnapshot snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  final providerName = bookingData['providerName'] ?? '';
                  final providerId = bookingData['providerId'] ?? '';
                  final providerNumber = bookingData['providerNumber'] ?? '';
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (jobStatus == 'Completed' && reviewAdded == 'false')
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Column(
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ElevatedButton(
                                          onPressed: () {
                                            Navigator.push(context, MaterialPageRoute(builder: (_) => RatingScreen(uploadedBy: providerId, serviceId: serviceId, bookingId: widget.bookingId,)));
                                          },
                                          style: ElevatedButton.styleFrom(
